...
export function useAuth() {
  ...
  async function logoutUser() {
    ...
    try {
      await fetch("https://galwinapp-d87b7b990a02.herokuapp.com/logout", {
        method: "POST",
        headers: {
  ...
  async function refreshAccessToken() {
    ...
    try {
      const response = await fetch('https://galwinapp-d87b7b990a02.herokuapp.com/refresh-token', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        try {
          const logoutRes = await fetch("https://galwinapp-d87b7b990a02.herokuapp.com/logout", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
              "csrf-token": csrfToken,
  ...
  async function fetchCsrfToken() {
    ...
    try {
      const response = await fetch("https://galwinapp-d87b7b990a02.herokuapp.com/csrf-token", {
        credentials: 'include'
      });
