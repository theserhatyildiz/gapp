...
export default function Account() {
    ...
    fetch("https://galwinapp-d87b7b990a02.herokuapp.com/update-username", {
        method: "POST",
    ...
    function logout() {
        fetch('https://galwinapp-d87b7b990a02.herokuapp.com/logout', { // Ensure you have the correct URL
            method: 'POST',
            headers: {
